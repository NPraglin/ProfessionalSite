        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="WorkByte"
              description="A web-based React application where users can sign up, and and rate rentable office-spaces! Using Google's Map API, users can input the actual location of the office. As a developer, I'm often traveling and searching for a good work environment. This application helps coders around the world. Check out the github page for the road map."
              link="https://workbyte-1fbfc.web.app/"
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={true}
              title="Chess Blog"
              description="A web-based Python/Django blog I developed to practice deploying an application. Fully functional user registration, login, and posting. I'm a passionate Chess player, feel free to sign up and post some information! Or send me a game request on Chess.com, my username is NPraglin. I'm also looking for collaborators to connect an interactive chess-board to my site."
